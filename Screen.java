...
implements Drawable {
    ...
    protected void remove(Element child) {
        if (child instanceof Drawable) {
            this.drawables.remove((Object)((Drawable)child));
        }
        if (child instanceof Selectable) {
            this.selectables.remove((Object)((Selectable)child));
        }
     ...
     */
    protected static void handleClickEvent(ClickEvent clickEvent, MinecraftClient client, Screen screenAfterRun) {
        ...
        int n = 0;
        switch (SwitchBootstraps.typeSwitch(new Object[]{ClickEvent.RunCommand.class, ClickEvent.ShowDialog.class, ClickEvent.Custom.class}, (Object)clickEvent3, (int)n)) {
            case 0: {
                String string;
     ...
     * Lifted jumps to return sites
     */
    protected static void handleBasicClickEvent(ClickEvent clickEvent, MinecraftClient client, Screen screenAfterRun) {
        v0 = clickEvent;
        Objects.requireNonNull(v0);
        clickEvent3 = v0;
        n = 0;
        switch (SwitchBootstraps.typeSwitch(new Object[]{ClickEvent.OpenUrl.class, ClickEvent.OpenFile.class, ClickEvent.SuggestCommand.class, ClickEvent.CopyToClipboard.class}, (Object)clickEvent3, (int)n)) {
            case 0: {
                openUrl = (ClickEvent.OpenUrl)clickEvent3;
                uRI2 = uRI = openUrl.uri();
                Screen.handleOpenUri(client, screenAfterRun, uRI2);
                v1 = false;
                ** break;
            }
            case 1: {
                openFile = (ClickEvent.OpenFile)clickEvent3;
                Util.getOperatingSystem().open(openFile.file());
                v1 = true;
                ** break;
            }
            case 2: {
                suggestCommand = (ClickEvent.SuggestCommand)clickEvent3;
                string /* !! */  = object /* !! */  = suggestCommand.command();
            ...
            case 3: {
                object /* !! */  = (ClickEvent.CopyToClipboard)clickEvent3;
                string2 = string = object /* !! */ .value();
...
lbl37: // 5 sources:
    ...
    protected static boolean handleOpenUri(MinecraftClient client, Screen screen, URI uri) {
    ...
    protected static void handleRunCommand(ClientPlayerEntity player, String command, Screen screenAfterRun) {
    ...
    public void addCrashReportSection(CrashReport report) {
        ...
        crashReportSection.add("Screen name", () -> ((Object)((Object)this)).getClass().getCanonicalName());
    }
    ...
    public static SelectedElementNarrationData findSelectedElementData(List<? extends Selectable> selectables, Selectable selectable) {
